...
function IconInfo({ color }) {
  return (
    <svg
      ...
      width="20.92"
      height="20.92"
      viewBox="0 0 20.92 20.92"
    >
      <g id="Group_1077" dataName="Group 1077" transform="translate(-24 -966)">
        <path
          id="Path_509"
          dataName="Path 509"
          d="M9,0A9,9,0,1,1,0,9,9,9,0,0,1,9,0Z"
          transform="translate(26 967)"
          fill={color}
        />
        <path
          id="_2107de337f3d7747a4fadbc1d2912bf0"
          dataName="2107de337f3d7747a4fadbc1d2912bf0"
          ...
          transform="translate(12.55 954.55)"
          fill="#fff"
        />
      </g>
    </svg>
